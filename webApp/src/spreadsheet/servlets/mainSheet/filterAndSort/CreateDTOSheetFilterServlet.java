...
import static spreadsheet.constants.Constants.RANGE_STR;

@WebServlet(name = "CreateDTOSheetFilterServlet", urlPatterns = "/mainSheet/createDTOSheetFilter")
public class CreateDTOSheetFilterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Extract columnToValues as a Map<String, List<String>>
            Type columnToValuesType = new TypeToken<Map<String, List<String>>>() {}.getType();
            Map<String, List<String>> columnToValues = gson.fromJson(gson.toJson(payload.get(COLUMN_TO_VALUES)), columnToValuesType);
            ...
            DTOsheet resultSheet = engine.filterColumnBasedOnSelection(sheetName, rangeStr, columnToValues, oldCoordToNewCoord);
